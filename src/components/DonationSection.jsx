  ...
  const handlePayment = async () => {
    ...
    if (formData.certificate) {
      if (
        ...
        setErrorMessage(
          "Please fill all certificate details (PAN Number, Address, City, State, Pincode) to receive 80G Certificate",
        );
    ...
    try {
      ...
      const endpoint = type === "one" ? "create-order" : "create-subscription";
      ...
      const options = {
        ...
        description: type === "one" ? "One-time Donation" : "Monthly Donation",
    ...
    <>
      <section className="main-section" id="donate">
        <div className="box">
          ...
          <p>
            Every meal brings comfort to caregivers watching over their loved
            ones
          </p>
          ...
          <div
            style={{ position: "relative", marginBottom: "8px", width: "100%" }}
          >
            <span
              style={{
                position: "absolute",
              ...
              {formData.mahaprasadam && finalAmount >= 1000 && (
                <div className="prasadam-address-section">
                  <p className="section-label">
                    Maha Prasadam Delivery Address:
                  </p>
